...
async function sendVacancyDetail(ctx, client, vacancyId) {
    await ctx.replyWithChatAction("typing");
...
async function sendApplyStep(ctx, draft) {
...
async function finishApply(ctx, client, chatId, draft) {
    await ctx.replyWithChatAction("typing");
...
async function sendSettings(ctx, client, chatId) {
    await ctx.replyWithChatAction("typing");
...
async function sendApplications(ctx, client, chatId) {
    await ctx.replyWithChatAction("typing");
...
async function sendNotifications(ctx, client, chatId) {
    await ctx.replyWithChatAction("typing");
...
export function createBot(token, convexBaseUrl, sharedSecret) {
